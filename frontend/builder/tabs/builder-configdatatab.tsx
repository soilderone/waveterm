        ...
        <div className="w-full h-full flex items-center justify-center bg-background">
            <div className="flex flex-col items-center gap-6 max-w-[500px] text-center px-8">
                ...
                <div className="flex flex-col gap-3">
                    <h2 className="text-2xl font-semibold text-primary">{t("builder.appNotRunning")}</h2>
                    <p className="text-base text-secondary leading-relaxed">
                        {t("builder.notRunningDesc")}
                    </p>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="w-full h-full flex items-center justify-center bg-background">
            <div className="flex flex-col items-center gap-6 max-w-2xl text-center px-8">
                ...
                <div className="flex flex-col gap-3">
                    <h2 className="text-2xl font-semibold text-error">{t("builder.errorLoadingData")}</h2>
    ...
    return (
        <div className="w-full h-full flex items-center justify-center bg-background">
            <div className="flex flex-col items-center gap-6">
                ...
                <p className="text-base text-secondary">{t("builder.loadingData")}</p>
            </div>
        </div>
    );
});
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                            <h4 className="text-base font-semibold text-primary flex items-center gap-2">
                                ...
                                {t("builder.sectionConfig")}
                            </h4>
                            <CopyButton title={t("builder.copyConfig")} onClick={handleCopyConfig} />
                        </div>
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                            <h4 className="text-base font-semibold text-primary flex items-center gap-2">
                                ...
                                {t("builder.sectionData")}
                            </h4>
                            <CopyButton title={t("builder.copyData")} onClick={handleCopyData} />
                        </div>
                        <div className="bg-panel border border-border rounded-lg p-4 overflow-auto">
                            <pre className="text-xs text-primary font-mono whitespace-pre">

...
const SearchComponent = ({
    ...
    const closeDecl: IconButtonDecl = {
        elemtype: "iconbutton",
        icon: "xmark-large",
        title: t("chrome.closeEsc"),
        click: () => setIsOpen(false),
    };

    const regexDecl = createToggleButtonDecl(regexAtom, "custom@regex", t("chrome.regex"));
    const wholeWordDecl = createToggleButtonDecl(wholeWordAtom, "custom@whole-word", t("chrome.wholeWord"));
    const caseSensitiveDecl = createToggleButtonDecl(
        caseSensitiveAtom,
        "custom@case-sensitive",
        t("chrome.caseSensitive")
    );

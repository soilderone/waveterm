        ...
        <div className="flex flex-col h-full">
            <header className="flex flex-col gap-2 border-b-0 p-0 mt-1 mb-4 w-full unselectable flex-shrink-0">
                ...
                <div className="text-center text-[25px] font-normal text-foreground">
                    {t("onboarding.upgrade.welcomeVersion", { version: "v0.14" })}
                </div>
            </header>
                ...
                <div className="flex flex-col items-center gap-3 w-full mb-2 unselectable">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="text-secondary leading-relaxed max-w-[600px] text-left">
                            <p className="mb-4">{t("onboarding.upgrade.aiDesc")}</p>
                            <p className="mb-4">
                                <span className="font-semibold text-foreground">
                                    {t("onboarding.upgrade.newInVersion", { version: "v0.13" })}
                                </span>{" "}
                                {t("onboarding.upgrade.aiLocalModels")}
                            </p>
                            <p className="mb-4">
                                <span className="font-semibold text-foreground">
                                    {t("onboarding.upgrade.newInVersion", { version: "v0.14" })}
                                </span>{" "}
                                {t("onboarding.upgrade.durableSessions")}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-3 text-center max-w-[550px]">
                        <div className="text-foreground text-base">{t("onboarding.upgrade.thanks")}</div>
                        <div className="text-secondary text-sm text-left">{t("onboarding.upgrade.starDesc")}</div>
                    </div>
                </div>
            </OverlayScrollbarsComponent>

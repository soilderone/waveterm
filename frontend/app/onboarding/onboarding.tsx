...
const InitPage = ({
    ...
    const label = telemetryEnabled ? t("onboarding.telemetryEnabledLabel") : t("onboarding.telemetryDisabledLabel");
                    ...
                    <div className="flex w-full items-center gap-[18px]">
                        ...
                        <div className="flex flex-col items-start gap-1 flex-1">
                            ...
                            <div className="text-secondary leading-5">
                                ...
                                {t("onboarding.openSourceMid")}
                                <i>{t("onboarding.openModelLabel")}</i>
                                {t("onboarding.openSourcePost")}
                                <a
                                    target="_blank"
                                    href="https://github.com/wavetermdev/waveterm?ref=install"
                                    rel="noopener"
            ...
            >
                <div className="flex flex-col items-center gap-6 w-full mb-2 unselectable">
                    <div className="text-center text-secondary leading-relaxed max-w-md">
                        <p className="mb-4">{t("onboarding.privacyRespect")}</p>
                        <p className="mb-4">{t("onboarding.telemetryStarDesc")}</p>
                    </div>
                </div>
            </OverlayScrollbarsComponent>

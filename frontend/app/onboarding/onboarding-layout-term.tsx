...
export const FakeTermBlock = ({
    ...
    const durableIconColor = durableStatus === "connected" ? "text-info" : "text-info/60";
...
const ConnectionOverlay = ({ state }: { state: OverlayState }) => {
    ...
    return (
        <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="bg-hoverbg backdrop-blur-[2px] rounded-lg flex flex-col items-center justify-center gap-4 px-12 py-8 w-[50%]">
                <i
                    className={cn(
                        "fa-sharp fa-solid",
                        isConnected ? "fa-wifi text-success" : "fa-wifi-slash text-error",
                        "text-6xl"
                    )}
                />

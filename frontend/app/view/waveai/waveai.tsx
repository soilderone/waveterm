    ...
    return (
        <div className="flex h-full w-full flex-col px-6 text-center">
            ...
            <div className="mx-auto flex w-full max-w-[760px] flex-col items-center">
                <h2 className="text-xl font-semibold text-primary">{t("ai.legacyTitle")}</h2>
                <p className="mt-3 text-sm leading-6 text-secondary">{t("ai.legacyDesc")}</p>
                <Button className="mt-6 cursor-pointer" onClick={handleOpenAIPanel}>
                    {t("ai.openWaveAiPanel")}
                </Button>
            </div>
